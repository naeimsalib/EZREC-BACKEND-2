...
# 🔧 Ensure status.json is writable by dual_recorder service
echo "📊 Setting up status.json permissions..."
sudo touch "$PROJECT_DIR/status.json"
sudo chown michomanoly14892:video "$PROJECT_DIR/status.json"
